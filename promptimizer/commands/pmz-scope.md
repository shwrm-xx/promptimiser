...
1. Reformuler la demande en **2 à 5 lots** : un titre court + un critère « fait quand : … »
   ...
   Si ce découpage porte une **feature/epic** identifiable (nom court, cap 60 caractères),
   le proposer aussi — sinon l'omettre (epic = label optionnel, pas une case obligatoire).
