...
4. Persister chaque lot validé (un appel par lot), avec sa préconisation de modèle, son
   ...
   `node ${CLAUDE_PLUGIN_ROOT}/scripts/backlog.js add --title "…" --scope "fait quand : …" --model sonnet --effort medium --verify "npm test" --epic "Nom de l'epic" --perimeter "src/a/**" --depends 12`
