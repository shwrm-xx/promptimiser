...
1. Produis un handoff court (modèle : `${CLAUDE_PLUGIN_ROOT}/templates/handoff-template.md`).
2. **Écris-le dans `.vibe-agent/handoff.md`** (écrase le contenu existant ; garde la
   ...
   (`node ${CLAUDE_PLUGIN_ROOT}/scripts/backlog.js show` les affiche) — jamais l'un sans
   l'autre.
